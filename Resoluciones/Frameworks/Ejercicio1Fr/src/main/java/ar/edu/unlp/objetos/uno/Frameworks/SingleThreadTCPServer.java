...
public abstract class SingleThreadTCPServer {
    ...
    private final void handleClient(Socket clientSocket) {
        ...
        try (
            ...
            String inputLine;
            while (this.verificarCondicion(inputLine = in.readLine())) {
            ...
            this.postComunicacion(clientSocket);
        } catch (IOException e) {
	...
	protected boolean verificarCondicion(String ln) {
		return (ln != null);
	}
	...
	protected void postComunicacion(Socket clientSocket) {
