...
public class ClienteGold extends Cliente{
	...
	public ProductoFinanciero crearProducto3() {
		ProductoFinanciero compraBonosAltoriesgo = new CompraBonoAltoRiesgo(24);
		ProductoFinanciero compraBonosBajoRiesgo = new CompraBonoBajoRiesgo(24);
		ProductoFinanciero plazoFijo = new PlazoFijo(30, 6);
		ProductoCombinado p3 = new ProductoCombinado();
		p3.agregarProducto(compraBonosAltoriesgo);
		p3.agregarProducto(compraBonosAltoriesgo);
		p3.agregarProducto(plazoFijo);
		return p3;
	}
	
	public ProductoFinanciero crearProducto4() {
		ProductoFinanciero compraBonosAltoriesgo = new CompraBonoAltoRiesgo(24);
		ProductoFinanciero compraBonosAltoriesgo2 = new CompraBonoAltoRiesgo(24);
		ProductoFinanciero compraBonosAltoriesgo3 = new CompraBonoAltoRiesgo(24);
		ProductoCombinado p4 = new ProductoCombinado();
		p4.agregarProducto(compraBonosAltoriesgo);
		p4.agregarProducto(compraBonosAltoriesgo2);
		p4.agregarProducto(compraBonosAltoriesgo3);
		return p4;
	}
