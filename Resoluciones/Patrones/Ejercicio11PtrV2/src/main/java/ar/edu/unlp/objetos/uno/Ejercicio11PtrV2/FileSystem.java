	...
	private Directorio raiz = new Directorio("");
	 ...
	 /**
	  ...
	  public int tamanoTotalOcupado() {
		 return this.raiz.calcularTamaño();
	  }
	  ...
	  public Archivo archivoMasGrande() {
		  return this.raiz.calcularMaximoTamaño();
	  }
	  ...
	  public Elemento buscar(String nombre){
		  return this.raiz.buscarTodosLosIguales(nombre).getFirst();
	  }
	   ...
	   */
	 // public List<String> buscarTodos(String nombre){
